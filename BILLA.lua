...
local UserName = (data.username_ or "SY_SB")
...
--------------------------------------------------------------------------------------------------------------
function SourceBILLA(msg,data) -- بداية العمل هيمو ال تميم
if msg then
...
send(msg.chat_id_, msg.id_,' *«⌾تم تحديث السورس* \n*«⌾لديك اخر اصدار لسورس بيلي*\n*«⌾الاصدار » { 2.8v}*')
dofile('BILLA.lua')  
end
if text == 'الاصدار «⌾' and DevBILLAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *«⌾اصدار سورس بيلي* \n*«⌾الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت «⌾' and DevBILLAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' «⌾[تحديثات البوت](t.me/F_2OO) \n«⌾[قناه السورس](t.me/SY_SB)')
end
...
usertext = '*\n «⌾اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'SY_SB')..')'
status  = '\n *«⌾تم ترقيته مطور*'
...
usertext = '\n *«⌾اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SY_SB')..')'
status  = '\n*«⌾تم ترقيته مطور*'
...
if BILLA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *«⌾اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SY_SB')..') \n «⌾'..BILLA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *«⌾العضو :* {["..data.first_name_.."](T.ME/SY_SB)}\n«⌾["..BILLA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *«⌾عذرا ↫* {["..data.first_name_.."](T.ME/SY_SB)}\n*«⌾عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
bnnaGet(msg.sender_user_id_, SSSSSSY_name)
end
...
Text = [[
⩹━━━◍『𝘽𝙔』◍━━━⩺
«⌾↬[مطور سورس](t.me/B_0_11)
«⌾↬[مبرمج سورس](t.me/N_H_9)
⩹━━━◍『𝘽𝙔』◍━━━⩺
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
send(msg.chat_id_, msg.id_, '*«⌾بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SY_SB')..') \n*«⌾تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *«⌾بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SY_SB')..') \n*«⌾تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == 'العاب بيلي' or text == 'العاب اونلاين' or text == 'العاب' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس بيلي ◍ 
...
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘 ', url="t.me/SY_SB"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
if database:get(bot_id.."SSSSSSY:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'SSSSSSY:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if Get_info then
local TextS = "\n *«⌾اهلا بك في متجر ملفات بيلي*\n*«⌾ملفات السورس ↓*\n*⩹━━━◍『𝘽𝙔』◍━━━⩺*\n\n"
local TextE = "\n*⩹━━━◍『𝘽𝙔』◍━━━⩺*\n *«⌾علامة تعني { ✓ } ملف مفعل*\n *«⌾علامة تعني { ✘ } ملف معطل*\n *«⌾قناة سورس بيلي ↓*\n".." *«⌾*[اضغط هنا لدخول](t.me/SY_SB) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *«⌾عذرا الملف لايدعم سورس بيلي* \n") 
end
return false
end
...
st = https.request('https://SSSSSSY.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://SSSSSSY.ml/Imagelnfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *«⌾العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'SY_SB')..')'
status  = '\n*«⌾تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *«⌾لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SY_SB')..')'
status  = '\n*«⌾تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *«⌾اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *«⌾العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SY_SB')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *«⌾اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'SY_SB')..')'..'\n*«⌾تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'SSSSSSY:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'SSSSSSY:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بيلي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بيلي')
local BILLA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n«⌾ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'F_2OO')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SY_SB')..')'
local iduser = result.sender_user_id_
...
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭y', url="t.me/F_2OO"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://SSSSSSY.ml/amirZhfa/Teland.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*«⌾قائمه الزخرفه* \nٴ«⌾∫ٴ*⩹━━━◍『𝘽𝙔』◍━━━⩺*ٴ«⌾∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ«⌾∫ٴ*⩹━━━◍『𝘽𝙔』◍━━━⩺*ٴ«⌾∫○ٴ\n«⌾[🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭y](t.me/SY_SB) ')
end
...
gk = https.request('https://SSSSSSY.ml/amirBrg/Teland.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://SSSSSSY.ml/amirOmr/Teland.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
keyboard = {}  
keyboard.inline_keyboard = {
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭y', url="https://t.me/SY_SB"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
{{text = '⓽', callback_data="/help9"},{text = '⓵⓪', callback_data="/help10"}},
{{text = 'الاوامر الرئيسيه', callback_data="/help"}},
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭??', url="t.me/F_2OO"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if DAata == '/help5' then
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʙɪʟʟᴀ',url='http://t.me/F_2OO'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بيلي')
